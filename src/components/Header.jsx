      ...
      <div className={styles.mainHeader}>
        <div className={styles.headerContainer}>
          ...
          <nav className={styles.desktopNav}>
            <NavLink to={`/prodotti?category=0&skinType=0&limit=10&page=1&minPrice=0&maxPrice=999&search=&order=a-z`} className={styles.navLink}>Prodotti</NavLink>
          ...
          <div className={styles.desktopActions}>
            ...
            <div className={styles.searchBox}>
              <i onClick={() => { navigation(`/prodotti?category=0&skinType=0&limit=10&page=1&minPrice=0&maxPrice=999&search=${search}&order=a-z`); setSearch("") }} className={`bi bi-search ${styles.searchIcon}`}></i>
              <input
                type="text"
                placeholder="Cerca..."
      ...
      <div className={`${styles.mobileMenuOverlay} ${isMenuOpen ? styles.active : ''}`}>
        <div className={styles.mobileMenuContent}>
          ...
          <nav className={styles.mobileNav}>
            <NavLink onClick={closeMenu} to={`/prodotti?category=0&skinType=0&limit=10&page=1&minPrice=0&maxPrice=999&search=&order=a-z`} className={styles.navLink}>Prodotti</NavLink>
            <NavLink to={`/sendcontacts`} className={styles.navLink}>Contattaci</NavLink>
